...
There are slight differences in behavior between `##` and `---`. The former will allow a blank page with no title or image, while the latter will not allow a blank page at all.
